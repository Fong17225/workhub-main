...
//            @Parameter(description = "Mật khẩu") @RequestParam String password) {
//        return userService.login(email, password, gr3.workhub.entity.User.Role.recruiter);
//    }
//
...
//            @Parameter(description = "Email") @RequestParam String email,
//            @Parameter(description = "Mật khẩu") @RequestParam String password) {
//        return userService.login(email, password, gr3.workhub.entity.User.Role.candidate);
//    }
//
